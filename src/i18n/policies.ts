...
export const policies: Record<Lang, PolicySet> = {
  hu: {
    privacy: {
      ...
      intro: 'Ez a tájékoztató bemutatja, hogyan kezeli a CONTAIT KFT ("Contai", "mi") a személyes adataidat, amikor a Contai platformot használod. Kérdés esetén írj a hello@contaigallery.com címre.',
      sections: [
        { heading: 'Ki kezeli az adataidat', body: ['Az adatkezelő a CONTAIT KFT. Az adatkezeléssel kapcsolatos kérdéseiddel a hello@contaigallery.com címen fordulhatsz hozzánk.'] },
        ...
        { heading: 'A te jogaid', body: ['Jogod van hozzáférni az adataidhoz, kérni azok helyesbítését vagy törlését, és tiltakozni a kezelésük ellen. Ehhez írj a hello@contaigallery.com címre. Panaszt a Nemzeti Adatvédelmi és Információszabadság Hatóságnál (NAIH) tehetsz.'] },
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: 'Kapcsolat', body: ['Kérdés esetén írj a hello@contaigallery.com címre.'] },
      ],
    },
  },
  en: {
    privacy: {
      ...
      intro: 'This policy explains how CONTAIT KFT ("Contai", "we") handles your personal data when you use the Contai platform. For questions, contact hello@contaigallery.com.',
      sections: [
        { heading: 'Who controls your data', body: ['The data controller is CONTAIT KFT. For any data-related questions, contact us at hello@contaigallery.com.'] },
        ...
        { heading: 'Your rights', body: ['You have the right to access your data, request correction or deletion, and object to its processing. To do so, write to hello@contaigallery.com. You may also lodge a complaint with the Hungarian data protection authority (NAIH).'] },
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: 'Contact', body: ['For questions, write to hello@contaigallery.com.'] },
      ],
    },
  },
  ro: {
    privacy: {
      ...
      intro: 'Această politică explică modul în care CONTAIT KFT ("Contai", "noi") gestionează datele tale personale când folosești platforma Contai. Pentru întrebări, contactează hello@contaigallery.com.',
      sections: [
        { heading: 'Cine îți controlează datele', body: ['Operatorul de date este CONTAIT KFT. Pentru orice întrebare legată de date, contactează-ne la hello@contaigallery.com.'] },
        ...
        { heading: 'Drepturile tale', body: ['Ai dreptul de a accesa datele tale, de a solicita corectarea sau ștergerea lor și de a te opune procesării. Pentru aceasta, scrie la hello@contaigallery.com. Poți depune și o plângere la autoritatea maghiară de protecție a datelor (NAIH).'] },
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: 'Contact', body: ['Pentru întrebări, scrie la hello@contaigallery.com.'] },
      ],
    },
  },
}
