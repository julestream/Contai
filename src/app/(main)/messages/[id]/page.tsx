...
export default async function MessagesPage() {
  ...
  // For each conversation, check if there are unread messages sent by the other person
  ...
  const unreadConvIds = new Set((unreadMessages || []).map((m: any) => m.conversation_id))
